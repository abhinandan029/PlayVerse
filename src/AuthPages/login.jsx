    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-4" style={TILE_BG}>
      ...
      <div className="w-full max-w-xl bg-black border border-white/40 rounded-2xl p-8">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="flex items-center justify-center gap-3 bg-white/10 border border-white/20 rounded-lg py-2.5 text-white font-semibold text-xl cursor-pointer">
          ...
          <button className="flex items-center justify-center gap-3 bg-white/10 border border-white/20 rounded-lg py-2.5 text-white font-semibold text-xl">
